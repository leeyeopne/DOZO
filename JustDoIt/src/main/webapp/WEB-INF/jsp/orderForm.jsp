					...
					<div class="checkout__order">
						...
						<div class="checkout__order__product">
							...
							<ul id="orderProductLists">
								...
								<c:forEach var="order" items="${orderList}">
									<li id="prodName">${order.product.prodName }
									<span id="prodPrice">${order.product.prodPrice }
									</span>
									</li>
								</c:forEach>
							</ul>
						...
						<div class="checkout__order__total">
							<ul>
								...
								<li>Total <span id="orderTotal">$ 750.0</span></li>
						...
						<div class="checkout__order__widget">
							...
							<p>Create am acount by entering the information below. If you
								are a returing customer login at the top of the page.</p>
